...
df.to_csv('gene_expression.csv',index=True,header=False)
...
df3 = pd.read_csv(Location, names=['gene','express'])
print df3
...
MaxName = df['gene'][df['express'] == MaxValue].values

# Text to display on graph
Text = str(MaxValue) + " - " + MaxName

# Add text to graph
plt.annotate(Text, xy=(1, MaxValue), xytext=(-300, -300), 
